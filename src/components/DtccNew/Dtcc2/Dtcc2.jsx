...
import group18306 from "./group-18306.png";
                    ...
                    <div className="frame-5">
                      <div className="frame-6">
                        <div className="frame-7">
                          ...
                          <div className="on-health-products">
                        ...
                        <div className="frame-9">
                          <button className="BUTTON">
                            <div className="shop-now">VISIT NOW</div>
                          </button>

                          <p className="homeopathy-ayurvedi">
                            Your all-in-one framework for Agile Product
                            Development.
                          </p>
                        </div>
                      </div>

                      <img className="group-5" alt="Group" src={group18306} />
                    </div>
                  </div>
                  ...
                  <div className="search-2">
                    ...
                    <div className="frame-12">
                      ...
                      <div className="BUTTON-2">
                        <div className="shop-now-2">SEARCH</div>
